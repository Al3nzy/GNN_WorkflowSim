...
This repository provides a unified framework combining **LIWSA** (Density-Adaptive Locust Swarm Optimisation) and its **GNN-based Warm-Start Extension** for cloud workflow scheduling inside WorkflowSim 1.1.0 and CloudSim 3.0.
...
A multi-objective swarm optimization algorithm where candidate schedules switch between solitary and gregarious phases based on local crowding density. It produces a true Pareto front across **Makespan** and **Execution Cost** without needing scalar weights or objective normalization.
...
| CyberShake_50 | 50 | 559.57 | 1631.05 | 0.150 |
| CyberShake_100 | 100 | 966.36 | 3350.46 | 0.326 |
| Epigenomics_24 | 24 | 4015.80 | 8384.21 | 0.082 |
| Epigenomics_46 | 46 | 7695.44 | 19942.00 | 0.154 |
| Epigenomics_100 | 100 | 55835.70 | 199899.00 | 0.346 |
| Inspiral_30 | 30 | 853.61 | 3141.33 | 0.084 |
| Inspiral_50 | 50 | 1352.08 | 5623.66 | 0.144 |
| Inspiral_100 | 100 | 2896.56 | 9930.78 | 0.310 |
| Montage_25 | 25 | 47.30 | 105.73 | 0.242 |
| Montage_50 | 50 | 84.01 | 242.82 | 0.172 |
| Montage_100 | 100 | 136.15 | 536.31 | 0.346 |
| Sipht_30 | 30 | 2207.63 | 2498.77 | 0.212 |
| Sipht_60 | 60 | 2332.87 | 5256.17 | 0.406 |
| Sipht_100 | 100 | 2438.34 | 8268.49 | 0.674 |
...
`export_weights.py` generates `gnn_weights.txt` in your working directory.
